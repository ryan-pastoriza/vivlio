<div class="col-md-12" style="padding:0;">
	<div class="panel panel-default" style="background:transparent;">
  		<div class="panel-heading" style="background:transparent;">
  			<h4 class="panel-title" style="color:#004040;"><i class="fa fa-signal"></i>Internet Entry</h4>
  		</div>
  		<div class="panel-body" style="max-height:590px; overflow:auto;">
  			<!-- begin timeline -->
			<ul class="timeline">
			 	@foreach($data['logs_data']['internet_entry'] as $value)
				 		...
				 		<li>
					        ...
					        <div class="timeline-body">
					            ...
					            <div class="timeline-content">
		                            <p>
		                               <small>Internet Entry :   {{date('F j, Y', strtotime($value['time']))}} at {{date('h:i A', strtotime($value['time']))}}</small>
		                            </p>
					            </div>
					        </div>
					        <!-- end timeline-body -->
